...
This is based of the original [HTML only version](https://github.com/gavinwmartin/simple-countdown-timer-html) of the countdown timer but adapted to be used with Bitfocus Companion.
